...
const posts = ref([
  { autor: 'Esmeralda', titulo: 'Nueva pintura', fecha: 'Lunes 11:46 am', texto: '', imagen: '/img/perfil1.jpg' },
  { autor: 'Daniela', titulo: 'Vacaciones', fecha: 'Martes 9:15 am', texto: '', imagen: '/img/perfil2.png' },
  { autor: 'Valentina', titulo: 'Nueva receta', fecha: 'Martes 1:30 am', texto: '', imagen: '/img/perfil1.jpg' },
])
